...
public class TestPagevl extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.testnohint); // possibly change to .test_hint
		...
		// Listening to Go To button click
		...
		questionTextView=(TextView) findViewById(R.id.noHintQuestionTextView);
