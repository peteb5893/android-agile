...
public class DatabaseHandler_test extends SQLiteOpenHelper {
...
//	private static final String KEY_CAT = "tutorialcat";
	...
	public DatabaseHandler_test(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_QUANTS_TABLE = "CREATE TABLE " + TABLE_QUANTS + "("
				...
				+ " TEXT," + KEY_CAT + " TEXT," + KEY_OPTION1 + " TEXT,"
		...
		String CREATE_CPPLANGUAGE_TABLE = "CREATE TABLE " + TABLE_CPPLANGUAGE
				...
				+ KEY_CPPLANGUAGEQUES + " TEXT," + KEY_CAT + " TEXT,"
		...
		String CREATE_JAVALANGUAGE_TABLE = "CREATE TABLE " + TABLE_JAVALANGUAGE
				...
				+ KEY_JAVALANGUAGEQUES + " TEXT," + KEY_CAT + " TEXT,"
				+ KEY_OPTION1 + " TEXT," + KEY_OPTION2 + " TEXT," + KEY_OPTION3
				+ " TEXT," + KEY_OPTION4 + " TEXT," + KEY_SOL + " TEXT"
				+ ")";
		...
		String CREATE_VL_TABLE = "CREATE TABLE " + TABLE_VL + "(" + KEY_VLID
				+ " INTEGER PRIMARY KEY," + KEY_VLQUES + " TEXT," + KEY_CAT
		...
		String CREATE_TUTORIAL_TABLE = "CREATE TABLE " + TABLE_TUTORIAL + "("
				+ KEY_TUTID + " INTEGER PRIMARY KEY," + KEY_CAT + " TEXT,"
				+ KEY_TUTQUES + " TEXT" + ")";
	...
	void addQuants(QuantsTable quants) {
		...
		values.put(KEY_CAT, quants.getCat());
	...
	QuantsTable getQuants(int id, String cat) {
		...
		Cursor cursor = db.query(TABLE_QUANTS, new String[] { KEY_QUANTSID,
				KEY_QUANTSQUES, KEY_CAT, KEY_OPTION1, KEY_OPTION2,
	...
	CTable getC(int id) {
		...
		Cursor cursor = db.query(TABLE_CLANGUAGE, new String[] {
				KEY_CLANGUAGEID,  KEY_CLANGUAGEQUES,KEY_CAT, KEY_OPTION1,
	...
	CTable getC(int id,String cat) {
		...
		Cursor cursor = db.query(TABLE_CLANGUAGE, new String[] {
				KEY_CLANGUAGEID, KEY_CLANGUAGEQUES, KEY_CAT, KEY_OPTION1,
				KEY_OPTION2, KEY_OPTION3, KEY_OPTION4, KEY_SOL },
				KEY_CLANGUAGEID + "=?" 	+ " AND " + KEY_CAT + "=" + "'" + cat + "'", new String[] { String.valueOf(id) },
				null, null, null, null);
		if (cursor != null)
			cursor.moveToFirst();
	...
	CppTable getCpp(int id, String cat) {
		...
		Cursor cursor = db.query(TABLE_CPPLANGUAGE,
				new String[] { KEY_CPPLANGUAGEID, KEY_CPPLANGUAGEQUES,
						KEY_CAT, KEY_OPTION1, KEY_OPTION2, KEY_OPTION3,
	...
	JavaTable getJava(int id) {
		...
		Cursor cursor = db.query(TABLE_JAVALANGUAGE,
				new String[] { KEY_JAVALANGUAGEID, 
						KEY_JAVALANGUAGEQUES,KEY_CAT, KEY_OPTION1, KEY_OPTION2,
	...
	JavaTable getJava(int id,String cat) {
		...
		Cursor cursor = db.query(TABLE_JAVALANGUAGE,
				new String[] { KEY_JAVALANGUAGEID, 
						KEY_JAVALANGUAGEQUES,KEY_CAT, KEY_OPTION1, KEY_OPTION2,
						KEY_OPTION3, KEY_OPTION4, KEY_SOL },
				KEY_JAVALANGUAGEID + "=?" + " AND " + KEY_CAT + "=" + "'" + cat + "'", new String[] { String.valueOf(id) },
				null, null, null, null);
	...
	VLTable getVL(int id, String cat) {
		...
		Cursor cursor = db.query(TABLE_VL, new String[] { KEY_VLID, KEY_VLQUES,
				KEY_CAT, KEY_OPTION1, KEY_OPTION2, KEY_OPTION3, KEY_OPTION4,
				KEY_SOL }, KEY_VLID + "=?" + " AND " + KEY_CAT + "=" + "'"
